...
extern long Callback(void *post_gpu_data, network *gpu_net,  TH2F *gpu_hist, netcluster *pwc, double **FP, double **FX, size_t *streamCount);
...
{
	Callback(post_gpu_data, gpu_net, gpu_hist, pwc, FP, FX, streamCount);
}
/*
