...
/*	for(; l<=le; l+=grid_size)
	{
		gpu_output[l*V4] = V;
		gpu_output[l*V4+1] = V4;
		gpu_output[l*V4+2] = tsize;
		gpu_output[l*V4+3] = 0;	
	}*/
...
/*		if(!mm[l]) 
		{
			gpu_output[l*V4] = l;
			gpu_output[l*V4+1] = V;
			gpu_output[l*V4+2] = mm[l];
			gpu_output[l*V4+3] = tsize;
			continue;		// skip delay configurations
		}*/
		// _sse_point_ps 
...
//	gpu_output[l*V4] = V;
//	gpu_output[l*V4+1] = V4;
//	gpu_output[l*V4+2] = Es;
//	gpu_output[l*V4+3] = rE;
