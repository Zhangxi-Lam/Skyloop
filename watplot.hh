...
public:
  ...
  inline void clear() { 
    ...
    graph.clear();
    //if(hist2D) { delete hist2D;  hist2D = NULL; }   // this instruction produce a crash , why???
  }
  ...
  void plot(wavearray<double>&, char* =NULL, int=1, double=0., double=0., 
            bool=false, float=0., float=0., bool=false, float=0.);
  ...
  void plot(wavearray<double>* ts, char* o=NULL, int c=1, double t1=0., double t2=0.,
            bool fft=false, float f1=0., float f2=0., bool psd=false, float t3=0.) {
    plot(*ts, o, c, t1, t2, fft, f1, f2, psd, t3); 
  }
  ...
  void plot(wavearray<float>* ts, char* o=NULL, int c=1, double t1=0., double t2=0.,
    ...
    wavearray<double> tf;
    waveAssign(tf,*ts);
    plot(tf, o, c, t1, t2, fft, f1, f2, psd, t3); 
  }
...
//  }
  ...
  // opt   : draw options
  // pal   : draw palette
  void plot(netcluster* pwc, int cid, int nifo, char type='L', int irate=0, char* opt=NULL, int pal=256);
