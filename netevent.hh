...
//   Gabriele Vedovato, University of Padova
//////////////////////////////////////////////////////////
...
#define NETEVENT_INIT                                                                          \
      iFile(NULL),fChain(NULL),run(0),nevent(0),eventID(NULL),type(NULL),name(NULL),rate(NULL),\
...
//   Int_t  LoadTree(Int_t entry);
   ...
   inline void dopen(const char *fname, char* mode, bool header=true) {
     ...
     if(header) fprintf(fP,"# WAT Version : %s - SVN Revision : %s",watversion('f'),watversion('r'));  	
   }
   ...
   inline void Dump(TString analysis="2G") {
     ...
     fprintf(fP,"eBBH:       ");  for(i=0; i<3; i++) fprintf(fP,"%f ",eBBH[i]);      fprintf(fP,"\n");  
     ...
     fprintf(fP,"segment:    ");  for(i=0; i<I; i++) 
				     fprintf(fP,"%12.4f %12.4f ",
					     gps[i],gps[i]+left[i]+right[i]+duration[i]); fprintf(fP,"\n"); 
     ...
     fprintf(fP,"duration:   ");  for(i=0; i<I; i++) fprintf(fP,"%f ",duration[i]);  fprintf(fP,"\n");  
     fprintf(fP,"frequency:  ");  for(i=0; i<I; i++) fprintf(fP,"%f ",frequency[i]); fprintf(fP,"\n");  
     fprintf(fP,"low:        ");  for(i=0; i<I; i++) fprintf(fP,"%f ",low[i]);       fprintf(fP,"\n");  
     fprintf(fP,"high:       ");  for(i=0; i<I; i++) fprintf(fP,"%f ",high[i]);      fprintf(fP,"\n");  
     fprintf(fP,"bandwidth:  ");  for(i=0; i<I; i++) fprintf(fP,"%f ",bandwidth[i]); fprintf(fP,"\n");  
